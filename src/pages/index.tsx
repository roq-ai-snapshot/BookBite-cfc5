  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Empower Your Culinary Journey with BookBite: The Ultimate SaaS Application for Streamlining Restaurant Management and Enhancing Guest Experiences"
        />
      </Head>
